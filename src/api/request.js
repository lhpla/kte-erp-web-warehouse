...
const request = (url, params, method, isJson = false, isFromData = false) => {
 ...
 * @returns {Promise}
 */
export function post(url, params, isJson, isFromData) {
  return request(url, params, 'post', isJson, isFromData)
}
