...
<template>
  <div id="SearchPanel">
    ...
    >
      <div
        class="form-content"
        :class="{ collapseClass: searchShow }"
      >
        ...
        <el-form-item label="选品状态" class="SearchPanel-form-item">
          <el-select
...
import { localGet, parseTime, cloneParmas } from "@/utils/util";
import authorButtons from "@/compositionApi/authorButtons";
import { useShowSearchBtn } from "@/compositionApi/useShowSearchBtn";

export default {
  name: "ChooseProductsSearch",
  setup(prop, ctx) {
    ...
    const onSubmit = () => {
      let msg = {
        ...
        spu: data.formInline.spu,
        transportType:
          data.formInline.transportType.length > 0
            ? data.formInline.transportType.join(",")
            : "",
