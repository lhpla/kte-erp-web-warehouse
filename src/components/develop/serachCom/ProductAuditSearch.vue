...
<template>
  <div id="SearchPanel">
    <el-form :inline="true" size="mini" ref="formInlineRef" label-width="130px" :model="formInline" class="demo-form-inline el-from">
      <div class="form-content" :class="{ collapseClass: searchShow }">
        ...
        <el-form-item label="选品名称" class="SearchPanel-form-item">
          <el-tooltip effect="dark" :content="formInline.productCname" :disabled="formInline.productCname" placement="bottom">
            <el-input v-model="formInline.productCname" placeholder="输入选品名称" clearable @change="onSubmit"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item label="产品状态" class="SearchPanel-form-item">
        ...
        <el-form-item label="SPU中文关键字" class="SearchPanel-form-item">
          <el-input v-model="formInline.spuChineseKeywords" placeholder="请输入SPU中文关键字" clearable @change="onSubmit"></el-input>
        </el-form-item>
        ...
        <el-form-item label="开发负责人" class="SearchPanel-form-item">
          <el-select v-model="formInline.developmentDirector" filterable placeholder="请选择" clearable @change="onSubmit">
            <el-option v-for="item in DevelopmentList" :key="item.id" :label="item.realName" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="采购负责人" class="SearchPanel-form-item">
          <el-select v-model="formInline.procurementLeader" filterable placeholder="请选择" clearable @change="onSubmit">
            <el-option v-for="item in ProcurementList" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
...
export default {
  ...
  setup(prop, ctx) {
    ...
    //搜索
    const onSubmit = () => {
      console.log(data.formInline.transportType);
      let msg = {
        ...
        scroll: 0,
        current: 1,
        spuChineseKeywords: data.formInline.spuChineseKeywords,
      };
    ...
    const reset = () => {
      ...
      data.formInline.endTime = "";
      data.formInline.spuChineseKeywords = "";
      onSubmit();
    };
