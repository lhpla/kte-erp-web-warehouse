    ...
    <el-form :inline="true" size="mini" ref="formInlineRef" label-width="80px" :model="formInline" class="demo-form-inline el-from">
      <div class="form-content" :class="{ collapseClass: searchShow }">
        ...
        <el-form-item label="时 间" class="SearchPanel-form-item">
          <div class="flex">
            <el-select v-model="formInline.timeType" @change="timeTypeChange" style="width: 100px; margin-right: 5px" clearable filterable placeholder="请选择">
        ...
        <el-form-item label="异常状态" class="SearchPanel-form-item">
          <el-select v-model="formInline.abnormalState" filterable placeholder="请选择" clearable  @change="onSubmit">
            <el-option v-for="item in pro_purchase_exception" :key="item.dizKey" :label="item.value" :value="item.dizKey"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="二次分配" class="SearchPanel-form-item">
          <el-select v-model="formInline.isDevelopSecondDistribution" filterable placeholder="请选择" clearable  @change="onSubmit">
...
export default {
  ...
  setup(prop, ctx) {
    ...
    onMounted(() => {
      ...
      data.pro_purchase_exception = localGet("dictCodeList").pro_purchase_exception ? localGet("dictCodeList").pro_purchase_exception : [];
      // 平台
